...
def process_variant(dataset, variant, data_path):  # NOQA
    ...
    if variant['use_image']:
        ...
        variant['online_offline_split_replay_buffer_kwargs']['offline_replay_buffer_kwargs']['max_size'] = int(2E5)
        variant['online_offline_split_replay_buffer_kwargs']['online_replay_buffer_kwargs']['max_size'] = int(3E5)
